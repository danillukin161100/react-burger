...
export const ingridientsSlice = createSlice({
	...
	selectors: {
		...
		getIngridientsByCategory: createSelector(
			[(state) => ingridientsSlice.getSelectors().getAllIngridients(state), (state, categoryKey) => categoryKey],
...
export const { getAllIngridients, getIngridientsByCategory, getCurrentCategoryKey, getModalIngridient } = ingridientsSlice.selectors;
